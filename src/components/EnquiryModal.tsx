...
import { X, Calendar, ArrowRight, ChevronDown, Loader2 } from "lucide-react";
                    ...
                    <div className="relative p-8 md:p-10 overflow-y-auto max-h-[90vh] scrollbar-hide">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <button
                                ...
                                className="w-full bg-[#EBEBEB] hover:bg-white text-[#540d2d] text-lg font-bold py-4 rounded-xl flex items-center justify-center gap-3 transition-all active:scale-[0.98] shadow-xl disabled:opacity-60 disabled:cursor-not-allowed"
                            >
                                {isSubmitting ? (
                                    <>
