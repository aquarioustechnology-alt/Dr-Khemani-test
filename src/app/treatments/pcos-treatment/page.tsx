...
export default function PCOSTreatmentPage() {
    ...
    return (
        <main className="relative">
                            ...
                            <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                                ...
                                <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} transition={{ duration: 0.8, delay: 0.2 }} className="relative h-[450px] md:h-[550px] order-first">
                                    <div className="absolute inset-0 rounded-[2.5rem] overflow-hidden shadow-2xl border-4 border-white">
                                        <Image src="/images/PCOS-bg.png" alt="PCOS treatment and awareness by Dr. Vinita Khemani" fill className="object-cover" priority />
                                    </div>
                                    {/* Float Card */}
                    ...
                    <div className="grid lg:grid-cols-2 gap-16 items-start">
                        ...
                        <div className="relative sticky top-32">
                            <div className="relative h-[500px] rounded-[2.5rem] overflow-hidden shadow-2xl border-4 border-white">
                                <Image src="/images/pcos-awareness-indian.jpg" alt="PCOS awareness and treatment for women by Dr. Vinita Khemani" fill className="object-cover" />
                            </div>
                    ...
                    <div className="grid lg:grid-cols-2 gap-16 items-start">
                        <div className="max-w-xl sticky top-32">
                            ...
                            <div className="relative h-[400px] rounded-[2rem] overflow-hidden shadow-2xl">
                                <Image src="/images/2023-04-23 (1).webp" alt="Dr. Vinita Khemani explaining PCOS causes during consultation" fill className="object-cover" />
                            </div>
                        </div>
                    ...
                    <div className="grid lg:grid-cols-2 gap-16 items-start">
                        ...
                        <div className="relative lg:order-first sticky top-32">
                            <div className="relative h-[600px] w-full rounded-[2.5rem] overflow-hidden shadow-2xl border-[6px] border-white">
                                <Image src="/images/2023-04-06.webp" alt="PCOS symptom awareness and diagnosis" fill className="object-cover" />
                ...
                <div className="container-fluid mx-auto max-w-[1400px] px-6">
                    <div className="grid lg:grid-cols-2 gap-12 items-start">
                        ...
                        <div className="relative h-[500px] rounded-[2.5rem] overflow-hidden shadow-2xl border-4 border-white sticky top-32">
                            <Image src="/images/WhatsApp Image 2026-01-14 at 12.55.29 PM.jpeg" alt="PCOS diagnosis and hormonal evaluation by Dr. Vinita Khemani" fill className="object-cover" />
                        </div>
                    </div>
                </div>
            </section>
                ...
                <div className="container-fluid mx-auto max-w-[1400px] px-6">
                    <div className="grid lg:grid-cols-2 gap-16 items-start">
                        ...
                        <div className="relative h-[500px] rounded-[2.5rem] overflow-hidden shadow-2xl sticky top-32">
                            <Image src="/images/WhatsApp Image 2026-01-14 at 12.55.30 PM (1).jpeg" alt="PCOS long-term health risk consultation at Dr. Khemani clinic the city" fill className="object-cover" />
                ...
                <div className="container-fluid mx-auto max-w-[1400px] px-6">
                    <div className="grid lg:grid-cols-2 gap-16 items-start">
                        <div className="relative h-[600px] rounded-[3rem] overflow-hidden hidden lg:block shadow-2xl sticky top-32">
                            <Image src="/images/best-lady-gynecologist-kolkata.webp" alt="Dr. Vinita Khemani consulting with a PCOS patient" fill className="object-cover" />
                            ...
                            <div className="flex flex-col gap-6 sticky top-32">
                                <div className="bg-white p-8 rounded-2xl shadow-sm border border-pink-100">
                                    <div className="flex items-center gap-3 mb-4">
                                        ...
                                        <h4 className="font-bold text-gray-900 text-lg">Clinic Locations</h4>
                                    </div>
                                    <div className="flex flex-col">
                                        {[
                                            ...
                                            <div key={i} className="flex items-center gap-6 py-5 border-b border-gray-100 last:border-0 group hover:bg-gray-50/50 transition-colors -mx-4 px-4 rounded-xl">
                                                ...
                                                <div>
                                                    <p className="text-lg font-bold text-gray-900 group-hover:text-[#C21975] transition-colors">{hospital.name}</p>
                                                    {hospital.loc && <p className="text-sm text-gray-600">{hospital.loc}</p>}
                                                </div>
                                            </div>
                                        ))}
                                    </div>
                ...
                <div className="container-fluid mx-auto max-w-[1400px] px-6">
                    <div className="grid lg:grid-cols-2 gap-16 items-start">
                        <div className="relative h-[500px] rounded-[2.5rem] overflow-hidden shadow-2xl order-last lg:order-first sticky top-32">
                            <Image src="/images/pcos-exercise-yoga.jpg" alt="Yoga and exercise for PCOS management recommended by Dr. Khemani" fill className="object-cover" />
            ...
            <section className="py-24 bg-[#fdf8fa]">
                <div className="container-fluid mx-auto max-w-[1400px] px-6">
                    <div className="grid lg:grid-cols-2 gap-16 items-start">
                        ...
                        <div className="relative h-[500px] rounded-[2.5rem] overflow-hidden shadow-2xl border-4 border-white sticky top-32">
                            <Image src="/images/pcos-mental-health.jpg" alt="PCOS mental health and emotional support counseling" fill className="object-cover object-top" />
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className="py-24 bg-white">
                <div className="container-fluid mx-auto max-w-[1400px] px-6">
                    <div className="text-center mb-16">
                        ...
                        <h2 className="font-display text-3xl md:text-5xl font-bold text-gray-900 mb-4">Why Women <span className="text-[#C21975]">Trust Dr. Khemani</span> for PCOS</h2>
                        <p className="text-gray-600 text-lg max-w-3xl mx-auto">With over 23 years of clinical experience specializing in PCOS treatment, Dr. Vinita Khemani combines evidence-based medicine with a deeply empathetic approach to patient care across multiple hospitals in West Bengal.</p>
                    </div>
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 items-stretch bg-[#fff0f5] rounded-[2.5rem] p-8 md:p-12">
                        <div className="relative min-h-[500px] h-full rounded-[2rem] overflow-hidden shadow-xl">
                            <Image src="/images/pcos_doctor_consult_1771254617510.png" alt="Dr. Vinita Khemani - best PCOS specialist during patient consultation" fill className="object-cover" />
                        </div>
            ...
            {/* Shared CTA Section */}
            <SharedCTA title="Take Control of Your PCOS" subtitle="Schedule an appointment with Dr. Vinita Khemani for a comprehensive PCOS evaluation and personalized treatment plan at her clinics." />
            ...
            <script type="application/ld+json" dangerouslySetInnerHTML={{
                __html: JSON.stringify({
                    ...
                    "@graph": [
                        ...
                        {
                            "@type": "MedicalWebPage",
                            "name": "PCOS Treatment | Dr. Vinita Khemani",
                            "description": "Comprehensive PCOS/PCOD management by Dr. Vinita Khemani including hormonal evaluation, lifestyle counseling, fertility support, and long-term monitoring.",
                            "about": {
                        ...
                        },
                        {
                            ...
                            "description": "Senior gynecologist with 23+ years of experience specializing in PCOS treatment, laparoscopic surgery, and fertility care.",
                            "areaServed": {
                                "@type": "City",
                                "name": "Kolkata",
