        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          <div>
            ...
            <motion.div
              ...
              className="relative w-full max-w-md bg-white rounded-3xl p-8 shadow-[0_8px_30px_rgb(0,0,0,0.06)] border border-gray-100"
            >
              <div className="flex items-center gap-4 mb-4">
                <div className="w-14 h-14 flex items-center justify-center bg-white rounded-full shadow-sm border border-gray-100">
                ...
                <div>
                  <p className="font-bold text-gray-900 text-xl leading-tight">Google Reviews</p>
              ...
              <div className="flex items-end justify-between">
                <div className="space-y-1">
                  <div className="flex items-center gap-1">
                    {[1, 2, 3, 4, 0.5].map((star, i) => (
                      <span key={i} className="text-[#FBBC05] text-2xl">
                        {star === 0.5 ? (
